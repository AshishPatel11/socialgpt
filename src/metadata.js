...
const description = `Discover the power of AI-driven social media analytics. Boost engagement, grow your audience, and make smarter, data-driven decisions to elevate your social media strategy.`;
...
export const SEO_CONTENT = {
    ...
    aboutPage: {
        ...
        openGraph: {
            ...aboutPageCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.aboutPage,
        },
    },
    careerPage: {
        careerPageCommonMeta,
        openGraph: {
            ...careerPageCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.careerPage,
        },
    },
    faqPage: {
        faqPageCommonMeta,
        openGraph: {
            ...faqPageCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.faqPage,
        },
    },
    pricingPage: {
        pricingPageCommonMeta,
        openGraph: {
            ...pricingPageCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.pricingPage,
        },
    },
    comingSoonPage: {
    ...
    privacyPolicy: {
        ...
        openGraph: {
            ...privacyPolicyCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.privacyPolicyPage,
        },
    },
    contactUs: {
        contactUsCommonMeta,
        openGraph: {
            ...contactUsCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.contactPage,
        },
    },
    error404Page: {
        error404PageCommonMeta,
        openGraph: {
            ...error404PageCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.error404,
        },
    },
    error500Page: {
        error500PageCommonMeta,
        openGraph: {
            ...error500PageCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.error500,
        },
    },
    underMaintenance: {
        ...
        openGraph: {
            ...underMaintenanceCommonMeta,
            ...ogCommonMetadata,
            url: PAGE_PATH.underMaintenance,
        },
    },
